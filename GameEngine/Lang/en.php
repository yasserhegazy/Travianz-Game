...
define('BUILD_CROPPER', 'Build Cropper');
...
define('LEARN4', 'Follow your improvement and success and compare yourself to other players. Look at the Top 10 rankings and fight to win a daily medal.');
...
define('ATT_W_M', 'Attackers of the Day');
define('DEF_W_M', 'Defenders of the Day');
define('POP_W_M', 'Pop Climbers of the Day');
define('ROB_W_M', 'Robbers of the Day');
define('CLIMB_W_M', 'Rank Climbers of the Day');
define('ATT_DEF_10_W_M', 'Receiving this medal shows that you were in the top 10 of both Attackers and Defenders of the day');
define('ATT_3_W_M', 'Receiving this medal shows that you were in the top 3 Attackers of the day');
define('DEF_3_W_M', 'Receiving this medal shows that you were in the top 3 Defenders of the day');
define('POP_3_W_M', 'Receiving this medal shows that you were in the top 3 Pop Climbers of the day');
define('ROB_3_W_M', 'Receiving this medal shows that you were in the top 3 Robbers of the day');
define('CLIMB_3_W_M', 'Receiving this medal shows that you were in the top 3 Rank Climbers of the day');
define('ATT_10_W_M', 'Receiving this medal shows that you were in the top 10 Attackers of the day');
define('DEF_10_W_M', 'Receiving this medal shows that you were in the top 10 Defenders of the day');
define('POP_10_W_M', 'Receiving this medal shows that you were in the top 10 Pop Climbers of the day');
define('ROB_10_W_M', 'Receiving this medal shows that you were in the top 10 Robbers of the day');
define('CLIMB_10_W_M', 'Receiving this medal shows that you were in the top 10 Rank Climbers of the day');
define('RECEIVED_IN_W', 'Received in period');
...
// Hall of Fame
define('HALL_OF_FAME', 'Hall of Fame');
define('HOF_PERIOD', 'Period');
define('HOF_CATEGORY', 'Category');
define('HOF_WINNER', 'Winner');
define('HOF_ALLIANCE', 'Alliance');
define('HOF_POINTS', 'Points');
define('HOF_DATE', 'Date');
define('HOF_NO_RECORDS', 'No records yet. The Hall of Fame will be populated after the first medal distribution.');
define('HOF_TOP_ATTACKER', 'Top Attacker');
define('HOF_TOP_DEFENDER', 'Top Defender');
define('HOF_TOP_CLIMBER', 'Top Climber');
define('HOF_TOP_ROBBER', 'Top Robber');
define('HOF_TOP_ALLIANCE', 'Top Alliance');
define('RANK', 'Rank');
