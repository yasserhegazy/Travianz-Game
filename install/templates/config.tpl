...
<form action="process.php" method="post" id="dataform">
    ...
    <table>
        ...
        <tr>
            ...
            <td width="140"><input type="text" name="natars_ww_spawn_time" id="natars_ww_spawn_time" value="20" size="3"></td>
        </tr>
        <tr>
        	<td><span class="f9 c6">WW building plan spawn (Days):</span></td>
            <td width="140"><input type="text" name="natars_ww_building_plan_spawn_time" id="natars_ww_building_plan_spawn_time" value="20" size="3"></td>
        </tr>      
        <tr>
    ...
    <table>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr>
            <td><span class="f9 c6">Package "F" Amount of Gold:</span></td>
            <td><input type="text" name="plus-f-gold" id="plus-f-gold" value="5000"></td>
        </tr>
        <tr>
            <td><span class="f9 c6">Package "F" Price:</span></td>
            <td><input type="text" name="plus-f-price" id="plus-f-price" value="99,99"></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
            <td><span class="f9 c6">Package "G" Amount of Gold:</span></td>
            <td><input type="text" name="plus-g-gold" id="plus-g-gold" value="12000"></td>
        </tr>
        <tr>
            <td><span class="f9 c6">Package "G" Price:</span></td>
            <td><input type="text" name="plus-g-price" id="plus-g-price" value="199,99"></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
            <td><span class="f9 c6">Package "H" Amount of Gold:</span></td>
            <td><input type="text" name="plus-h-gold" id="plus-h-gold" value="20000"></td>
        </tr>
        <tr>
            <td><span class="f9 c6">Package "H" Price:</span></td>
            <td><input type="text" name="plus-h-price" id="plus-h-price" value="299,99"></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
