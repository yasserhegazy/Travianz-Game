...
//Plus Package F Price
define("PLUS_PACKAGE_F_PRICE","%PLUS_PACKAGE_F_PRICE%");
//Plus Package F Gold
define("PLUS_PACKAGE_F_GOLD","%PLUS_PACKAGE_F_GOLD%");
//Plus Package G Price
define("PLUS_PACKAGE_G_PRICE","%PLUS_PACKAGE_G_PRICE%");
//Plus Package G Gold
define("PLUS_PACKAGE_G_GOLD","%PLUS_PACKAGE_G_GOLD%");
//Plus Package H Price
define("PLUS_PACKAGE_H_PRICE","%PLUS_PACKAGE_H_PRICE%");
//Plus Package H Gold
define("PLUS_PACKAGE_H_GOLD","%PLUS_PACKAGE_H_GOLD%");
//Plus account lenght
