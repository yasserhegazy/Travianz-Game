...
class Process {
	...
	private function constForm() {
		...
		$findReplace["%PLUS_PACKAGE_F_GOLD%"] = $_POST['plus-f-gold'];
		$findReplace["%PLUS_PACKAGE_F_PRICE%"] = $_POST['plus-f-price'];
		$findReplace["%PLUS_PACKAGE_G_GOLD%"] = $_POST['plus-g-gold'];
		$findReplace["%PLUS_PACKAGE_G_PRICE%"] = $_POST['plus-g-price'];
		$findReplace["%PLUS_PACKAGE_H_GOLD%"] = $_POST['plus-h-gold'];
		$findReplace["%PLUS_PACKAGE_H_PRICE%"] = $_POST['plus-h-price'];
