...
<?php echo (defined('LANG') && LANG === 'ar') ? 'أنجح المدافعين' : 'The most successful defenders'; ?>
...
<img class="active btn_def" src="img/x.gif" alt="<?php echo (defined('LANG') && LANG === 'ar') ? 'مدافع' : 'defender'; ?>">
</a>
