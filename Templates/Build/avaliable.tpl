...
if((($greatwarehouse == 0 && $greatwarehouse1 == 0) || $greatwarehouse == 20) && $mainbuilding >= 10 && ($GreatGranaryWarehouseBuildable || $village->natar == 1 || 1) && ($id != 39 && $id != 40)) {
    include("avaliable/greatwarehouse.tpl");
}
if((($greatgranary == 0 && $greatgranary1 == 0) || $greatgranary == 20) && $mainbuilding >= 10 && ($GreatGranaryWarehouseBuildable  || $village->natar == 1 || 1) && ($id != 39 && $id != 40)) {
...
//fix marketplace
if($mainbuilding >= 3 && $market == 0 && $market1 == 0 && $id != 39 && $id != 40) {
